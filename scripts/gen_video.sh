...
ffmpeg -i $INPUT -c:v libvpx-vp9 -pass 1 -b:v 2000k -maxrate 3000k -speed 4 \
  -tile-columns 6 -frame-parallel 1 -threads 1 \
  -g 600 -r 30 -vf "histeq" -loglevel panic \
  -f webm -y /dev/null

ffmpeg -i $INPUT -c:v libvpx-vp9 -pass 2 -b:v 2000k -maxrate 3000k -speed 1 \
